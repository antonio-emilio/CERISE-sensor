...
void ESP_WiFiManager::reportStatus(String &page)
{
  ...
  if (WiFi_SSID() != "")
  {
    page += F("Atualmente configurado para o SSID <b>");
    page += WiFi_SSID();

    if (WiFi.status() == WL_CONNECTED)
    {
      page += F(" e atualmente conectado </b> no IP <a href=\"http://");
    ...
    {
      page += F(" mas nao esta atualmente conectado</b> na rede.");
    }
  }
  else
  {
    page += F("Nao ha nenhuma rede configurada anteriormente.");
  }
}
...
void ESP_WiFiManager::handleRoot()
{
  ...
  String base64_image = "data:image/jpeg;base64,"; // Insira sua string de dados base64 aqui
  ...
  page += "<h2><img src='" + base64_image + "' alt='Floats' style='display: block; margin: 0 auto;'></h2>";
  page += "<h2>";
  page += "Rede atual: ";
...
void ESP_WiFiManager::handleWifi()
{
  ...
  {
    page += F("Redes não encontradas. <br/>Verifique se o dispositivo está no alcance de uma rede WiFi.");
  }
  else
  {
  ...
  page += "<small>*Para reutilizar as credenciais ja salvas, deixe o SSID e a senha em brancos.</small>";
...
void ESP_WiFiManager::handleWifiSave()
{
  ...
  _phoneNumber = server->arg("phone").c_str();
  ...
  page.replace("{phone}", _phoneNumber);

  NVS.setString(PHONENUMBER, _phoneNumber);
