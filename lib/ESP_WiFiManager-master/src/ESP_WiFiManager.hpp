...
const char WM_HTTP_SCRIPT_NTP_MSG[] PROGMEM = "<p>Seu fuso horario : <b><label id='timezone' name='timezone'></b><script>document.getElementById('timezone').innerHTML=timezone.name();document.getElementById('timezone').value=timezone.name();</script></p>";
...
const char WM_HTTP_PORTAL_OPTIONS[] PROGMEM = "<form action='/wifi' method='get'><button class='btn'>Configurar rede</button></form><br/><form action='/i' method='get'><button class='btn'>Detalhar</button></form><br/><form action='/close' method='get'><button class='btn'>Sair</button></form><br/>";
...
const char WM_HTTP_FORM_START[] PROGMEM = "<form method='get' action='wifisave'><fieldset><div><label>SSID Primario</label><input value='[[ssid]]' id='s' name='s' length=32 placeholder='SSID Primario'><div></div></div><div><label>Senha Primaria</label><input value='[[pwd]]' id='p' name='p' length=64 placeholder='Senha Primaria'><div></div></div><div><label>SSID Secundario</label><input value='[[ssid1]]' id='s1' name='s1' length=32 placeholder='SSID Secundario'><div></div></div><div><label>Senha Secundaria</label><input value='[[pwd1]]' id='p1' name='p1' length=64 placeholder='Senha Secundaria'><div></div></div></fieldset>";
#else
...
const char WM_HTTP_SAVED[] PROGMEM = "<div class='msg'><b>Credenciais Salvas</b><br>Tente conectar o ESP à rede {x}/{x1}. Aguarde cerca de 10 segundos e verifique <a href='/'>se esta tudo certo.</a> <p/>O AP {v} funcionara no mesmo canal WiFi do AP {x}/{x1}. Talvez seja necessario reconectar manualmente ao AP {v}. O numero de telefone inserido foi {phone}.</div>";
